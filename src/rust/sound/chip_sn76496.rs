...
***************************************************************************/
use super::{RomIndex, SoundChipType, sound_chip::{SoundChip}, rom::RomBank, stream::{convert_sample_i2f, SoundStream}};
...
impl SoundChip for SN76496 {
    fn new(sound_device_name: SoundChipType) -> Self {
        match sound_device_name {
            ...
            SoundChipType::SN76489 => SN76496::new(0x4000, 0x01, 0x02, true, false, 8, false, true),
            _ => {
