...
const start = () => {
    ...
    fillTextCenterd("YM2149 | YM2151 | YM2203 | YM2413 | YM2608 | YM2610(B) | YM2612 | YM3526 | Y8950 | YM3812", CANVAS_HEIGHT / 2 - 32 * 4 + 16);
    fillTextCenterd("YMF262 | YMF278B | SN76489(MD) | PWM(32x) | SEGAPCM | OKIM6285(X68K) | C140 | C219", CANVAS_HEIGHT / 2 - 32 * 3 + 4);
    canvasContext.font = '20px sans-serif';
